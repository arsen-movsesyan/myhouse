...
--
-- Name: mh_1_account_main_house; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE mh_1_account_main_house (
    id integer NOT NULL,
...
ALTER TABLE mh_1_account_main_house OWNER TO postgres;
...
ALTER SEQUENCE mh_1_common_main_house_id_seq OWNED BY mh_1_account_main_house.id;
...
ALTER TABLE ONLY mh_1_account_main_house ALTER COLUMN id SET DEFAULT nextval('mh_1_common_main_house_id_seq'::regclass);
...
ALTER TABLE ONLY mh_1_account_main_house
